                ...
                for q_tag in q_tags:
                    ...
                    for q_id, _ in lessons[qs_tag][q_tag].items():
                        ...
                        if img_kind.startswith('abc'):
                            ...
                            imgs_info_path = os.path.join(self.json_dir, 'abc_question_images/abc_question_images.json')
                            ...
                            with open(q_dir + 'coordinate.txt', 'w') as f:
                                ...
                                for info in img_info:
                                    ...
                                    detailed_word_info['Top'] = info['rectangle'][1][1]
                                    ...
                                    word_dict['WordText'] = info['rectangle']['text']
